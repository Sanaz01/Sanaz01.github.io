...
-   Used **Dorado**, **Guppy** and **Megalodon** for HAC basecalling using **5mC**, **5hmC**, **6mA** Remora models
-   Parsed **BAM/SAM** files with **Samtools** to identify methylation frequency per **CpG** site across genome
-   Utilized **R packages** - **GenomicRanges** and **IRanges** for mapping sites against reference GCF files
